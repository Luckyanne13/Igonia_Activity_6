...
fun TopicGrid(modifier: Modifier = Modifier
    ...
    LazyVerticalGrid/*Scrollable*/(
        ...
        items(combinedList) { (topic,detail) ->
            TopicCard(topic,detail)
        }
    }
}
@Composable
fun TopicCard(detail: Detail, topic: Topic, modifier: Modifier = Modifier) {
        Card {
            ...
            Row {
                ...
                Column {
                    Text/*Text Loader*/(
                        text = stringResource(id = topic.name1),
                    ...
                    if (revealText) {
                        Text(text = stringResource(id = detail.name2),
                            modifier = Modifier
                                .padding(16.dp))
